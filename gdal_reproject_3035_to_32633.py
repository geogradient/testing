...
# Source
src_filename = '/media/jobel/work/VM_shared/GIS/bathymetry_Himmer_250m_epsg3035.tiff'
src = gdal.Open(src_filename, gdal.gdalconst.GA_ReadOnly)
src_proj = src.GetProjection()
src_geotrans = src.GetGeoTransform()

# We want a section of source that matches this:
match_filename = '/media/jobel/work/VM_shared/GIS/test3.tif'
...
# Output / destination
dst_filename = '/media/jobel/work/VM_shared/GIS/test04.tif'
dst = gdal.GetDriverByName('GTiff').Create(dst_filename, wide, high, 1, gdal.gdalconst.GDT_Float32)
...
def reproject_dataset ( dataset, \
            pixel_spacing=300., epsg_from=3035, epsg_to=32633 ):
    """
